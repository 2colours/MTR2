        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, @"
                ## Big Demo article...
                ", new DateTimeOffset(new DateTime(2019, 5, 23, 1, 55, 39, 73, DateTimeKind.Unspecified).AddTicks(9718), new TimeSpan(0, 2, 0, 0, 0)), "Welcome all!" },
                    { 2, 1, @"
                ## Big Demo article...
                ...
                *a**a**
                eh
                ", new DateTimeOffset(new DateTime(2019, 5, 23, 1, 55, 39, 76, DateTimeKind.Unspecified).AddTicks(9309), new TimeSpan(0, 2, 0, 0, 0)), "Another post here" }
                });
