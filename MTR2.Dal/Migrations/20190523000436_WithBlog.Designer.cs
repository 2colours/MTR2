...
namespace MTR2.Dal.Migrations
{
    ...
    [Migration("20190523000436_WithBlog")]
    partial class WithBlog
    {
...
## Big Demo article...
",
                            CreationDate = new DateTimeOffset(new DateTime(2019, 5, 23, 2, 4, 34, 886, DateTimeKind.Unspecified).AddTicks(9631), new TimeSpan(0, 2, 0, 0, 0)),
                            Title = "Welcome all!"
                        },
                        new
                        {
...
eh
",
                            CreationDate = new DateTimeOffset(new DateTime(2019, 5, 23, 2, 4, 34, 889, DateTimeKind.Unspecified).AddTicks(4462), new TimeSpan(0, 2, 0, 0, 0)),
